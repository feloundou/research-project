...
cyan_config       = dict(name='cyan',  penalty_lr=0.025, cost_lim=25, gamma=0.99, lam=0.98, seed=0, steps=10000, hid=128, l=4)
chrome_config     = dict(name='chrome',  penalty_lr=0.025, cost_lim=25, gamma=0.99, lam=0.98, seed=4444, steps=10000, hid=128, l=4)
...
lemon_config    = dict(name='lemon', penalty_lr=0.025, cost_lim=25, gamma=0.99, lam=0.98, seed=0, steps=10000, hid=128, l=2)
leaf_config    = dict(name='leaf', penalty_lr=0.025, cost_lim=25, gamma=0.99, lam=0.98, seed=4444, steps=10000, hid=128, l=2)
...
navy_config      = dict(name='navy', penalty_lr=0.025, cost_lim=200, gamma=0.99, lam=0.95, seed=0, steps=10000, hid=128, l=4)
nova_config      = dict(name='nova', penalty_lr=0.025, cost_lim=200, gamma=0.99, lam=0.95, seed=4444, steps=10000, hid=128, l=4)
...
petrichor_config = dict(name='petrichor', penalty_lr=0.001, cost_lim=40, gamma=0.99, lam=0.95, seed=0, steps=20000, hid=128, l=4)
polenta_config   = dict(name='polenta', penalty_lr=0.001, cost_lim=40, gamma=0.99, lam=0.95, seed=4444, steps=20000, hid=128, l=4)
...
ukelele_config = dict(name='ukelele', penalty_lr=0.025, cost_lim=80, gamma=0.99, lam=0.95, seed=0, steps=20000, hid=128, l=4)
uniform_config = dict(name='uniform', penalty_lr=0.025, cost_lim=80, gamma=0.99, lam=0.95, seed=4444, steps=20000, hid=128, l=4)
...
zebra_config = dict(name='zebra', penalty_lr=0.025, cost_lim=100, gamma=0.999, lam=0.95, seed=0, steps=10000, hid=128, l=4)
zany_config = dict(name='zany', penalty_lr=0.025, cost_lim=100, gamma=0.999, lam=0.95, seed=4444, steps=20000, hid=128, l=4)

#buttercup_config, brownsugar_config,
# cyan_config
CONFIG_LIST = [
               #chrome_config,
