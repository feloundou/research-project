...
RUN_NAME = 'ppo_penalized_violet_20Ks_1Ke_128x4'
...
if __name__ == "__main__":
  ...
  ppo(lambda: gym.make('Safexp-PointGoal1-v0'),
      actor_critic=MLPActorCritic,
      agent=PPOAgent(),
      ac_kwargs=dict(hidden_sizes=[violet_config['hid']] * violet_config['l']),
      gamma=violet_config['gamma'],
      lam=violet_config['lam'],
      cost_gamma=0.99,
      seed=violet_config['seed'],
      steps_per_epoch=violet_config['steps'],
      epochs=1000,
      cost_lim=violet_config['cost_lim'],
      penalty_lr=violet_config['penalty_lr'],
