...
PROJECT_NAME = 'ppo_penalized_cyan_20Ks_1Ke'
...
if __name__ == "__main__":
  ...
  logger_kwargs = setup_logger_kwargs("ppo_vm_cyan_5000ep", 0)
  ...
  ppo(lambda: gym.make('Safexp-PointGoal1-v0'),
      actor_critic=MLPActorCritic,
      agent=PPOAgent(),
      ac_kwargs=dict(hidden_sizes=[cyan_config['hid']] * cyan_config['l']),
      gamma=cyan_config['gamma'],
      lam=cyan_config['lam'],
      cost_gamma=0.99,
      seed=cyan_config['seed'],
      steps_per_epoch=cyan_config['steps'],
      epochs=1000,
      cost_lim=cyan_config['cost_lim'],
      penalty_lr=cyan_config['penalty_lr'],
